...
fn main() {
    ...
    for i in 1..=100 {
        ...
        println!("\t0,0 is {}", map.get(&(0,0)).unwrap());
        ...
        loop {
            ...
            println!("\tnumber of flashers on pass #{}: {}", flash_iter, flashers.len());
            if flashers.len() == 0 {
                break;
            }
        ...
        println!("after {} steps there have been {} total flashes", i, total_flashes);
    }
